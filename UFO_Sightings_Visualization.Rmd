...
```{r}
ggplot(data = countrysightings) + geom_histogram(mapping = aes(x = year, fill = month), bins = 100) + facet_wrap(~country ) + ggtitle("Reported UFO Sightings in Each Country by Month and Year") 
```
