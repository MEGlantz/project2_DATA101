...
```{r}
ggplot(data = countrysightings) + geom_histogram(mapping = aes(x = year, fill = month), bins = 100) + facet_wrap(~country ) + ggtitle("Reported UFO Sightings in Each Country by Month and Year") + scale_x_continuous(trans = "log10")
```

These faceted graphs give you a better impression of the annual monthly variation of sightings in each country.
